...
export const modalities = [
  ...
  },
  {
    ...
    scheduleCopy: "A grade da turma de Karatê ainda não foi publicada. Fale com a equipe para registrar seu interesse e receber novidades.",
    scheduleCtaLabel: "Ver disponibilidade",
    method: "Com orientação do Sensei Adriano, o Karatê na ECVO é apresentado por meio de fundamentos técnicos e evolução gradual, com atenção ao equilíbrio, à disciplina e à segurança.",
    related: ["karate-turma-kids-joao-pessoa", "krav-maga-joao-pessoa", "kickboxing-joao-pessoa"],
    cta: {
      shortLabel: "Tenho interesse",
      label: "Tenho interesse em Karatê",
      message: "Olá! Encontrei a ECVO pela página de Karatê e gostaria de saber quando os horários serão publicados.",
    ...
    faq: [["Posso começar Karatê sem experiência?", "Sim. Fale com a equipe para receber orientação sobre como começar quando a turma estiver disponível."], ["Quem conduz o Karatê na ECVO?", "As aulas de Karatê são conduzidas pelo Sensei Adriano, faixa-preta da modalidade e praticante de artes marciais há quase 40 anos."], ["Preciso comprar equipamentos antes de começar?", "A equipe informa previamente quais roupas e equipamentos serão necessários."], ["Quando serão divulgados os horários?", "Os horários serão publicados no site assim que estiverem disponíveis."]],
  },
  {
    ...
    faq: [["Para qual idade é a Turma Kids de Karatê?", "Confirme diretamente com a ECVO a faixa etária atendida e a disponibilidade atual da turma."], ["A criança precisa ter experiência?", "Não. A proposta permite começar pelos fundamentos, com orientação."], ["Quem conduz a Turma Kids de Karatê?", "As aulas são conduzidas pelo Sensei Adriano, faixa-preta de Karatê e praticante de artes marciais há quase 40 anos."], ["Quando é a Turma Kids de Karatê?", "A grade atual indica aulas às terças e quintas, às 10h e às 15h. Confirme a disponibilidade antes de ir."], ["Quais aspectos a prática desenvolve?", "A turma trabalha fundamentos do Karatê, movimento, coordenação, disciplina, respeito e convivência."]],
  },
  {
