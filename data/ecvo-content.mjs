...
export const teachers = {
  ...
  adriano: {
    name: "Sensei Adriano",
    area: "Karatê · Krav Maga · Autodefesa",
    image: "/assets/profAdriano.webp",
...
export const modalities = [
  ...
  },
  {
    ...
    heroImage: {
      src: "/assets/turmas/kickboxing-ecvo.webp",
      srcSet: "/assets/turmas/kickboxing-ecvo-800.webp 800w, /assets/turmas/kickboxing-ecvo.webp 1600w",
      width: 1600,
      height: 1200,
      alt: "Turma de Kickboxing da ECVO reunida no tatame",
      position: "50% 52%",
    },
  ...
  },
  {
    ...
    heroImage: {
      src: "/assets/turmas/muay-thai-ecvo.webp",
      srcSet: "/assets/turmas/muay-thai-ecvo-640.webp 640w, /assets/turmas/muay-thai-ecvo.webp 960w",
      width: 960,
      height: 1280,
      alt: "Turma de Muay Thai da ECVO reunida no tatame",
      position: "50% 52%",
    },
  ...
  {
    slug: "karate-joao-pessoa", name: "Karatê Adulto", title: "Karatê Adulto em João Pessoa | ECVO",
    description: "Para crianças de até 14 anos, a ECVO recomenda seu Karatê Kids. Para adultos, indica o professor parceiro Dennys Cardoso, que aluga a academia nas manhãs de sábado para aulas independentes.",
    hero: "Para crianças de até 14 anos, recomendamos o Karatê Kids da ECVO. A ECVO não oferece Karatê Adulto: o professor parceiro Dennys Cardoso aluga a academia nas manhãs de sábado para suas aulas independentes.",
    independentTeacher: {
      name: "Dennys Cardoso",
      phone: "+55 83 9959-2815",
      whatsapp: "558399592815",
      message: "Olá, professor Dennys! Encontrei seu contato na página de Karatê Adulto da ECVO e gostaria de saber os valores e horários das suas aulas.",
    },
    related: ["karate-turma-kids-joao-pessoa"],
    faq: [["A ECVO oferece Karatê Adulto?", "Não. Para adultos, indicamos o professor parceiro Dennys Cardoso, que aluga a academia nas manhãs de sábado para aulas independentes."], ["E para crianças de até 14 anos?", "Recomendamos o Karatê Kids oferecido pela ECVO. Consulte a página da turma para ver a grade e falar com a escola."], ["Como saber os valores e horários do Karatê Adulto?", "Fale diretamente com o professor Dennys Cardoso pelo WhatsApp +55 83 9959-2815."]],
  },
  {
    slug: "karate-turma-kids-joao-pessoa", name: "Karatê - Turma Kids", title: "Karatê - Turma Kids em João Pessoa | ECVO",
    description: "Karatê Kids da ECVO para crianças de até 14 anos, no Valentina, em João Pessoa. Conheça a turma e consulte os horários.",
    hero: "O Karatê Kids da ECVO é indicado para crianças de até 14 anos, com fundamentos, movimento, disciplina, respeito e convivência.",
    audiences: ["Crianças de até 14 anos que querem conhecer uma arte marcial com acompanhamento.", "Responsáveis que buscam uma prática de movimento, disciplina e convivência.", "Crianças iniciantes, respeitando o ritmo e a orientação da turma.", "Famílias que desejam confirmar a disponibilidade diretamente com a equipe."],
    ...
    method: "Com orientação do Sensei Adriano, a Turma Kids de Karatê trabalha os fundamentos da modalidade de forma gradual, com atenção ao movimento, à disciplina, ao respeito e à segurança.",
    related: ["karate-joao-pessoa", "kickboxing-infantil-joao-pessoa", "judo-turma-kids-joao-pessoa"],
    faq: [["Para qual idade é a Turma Kids de Karatê?", "A ECVO recomenda o Karatê Kids para crianças de até 14 anos. Confirme a disponibilidade atual da turma com a equipe."], ["A criança precisa ter experiência?", "Não. A proposta permite começar pelos fundamentos, com orientação."], ["Quem conduz a Turma Kids de Karatê?", "As aulas são conduzidas pelo Sensei Adriano, faixa-preta de Karatê e praticante de artes marciais há quase 40 anos."], ["Quando é a Turma Kids de Karatê?", "A grade atual indica aulas às terças e quintas, às 10h e às 15h. Confirme a disponibilidade antes de ir."], ["Quais aspectos a prática desenvolve?", "A turma trabalha fundamentos do Karatê, movimento, coordenação, disciplina, respeito e convivência."]],
  },
  {
    slug: "krav-maga-joao-pessoa", name: "Krav Maga", title: "Krav Maga em João Pessoa | ECVO",
    description: "Conheça o Krav Maga na ECVO, no Valentina, em João Pessoa, com orientação do Sensei Adriano e foco em segurança, disciplina e autodefesa.",
    hero: "Conheça o Krav Maga na ECVO, no Valentina, em João Pessoa, com uma prática orientada para desenvolver atenção, segurança, disciplina e fundamentos de autodefesa.",
    audiences: ["Pessoas interessadas em aprender fundamentos de autodefesa com orientação.", "Iniciantes que buscam uma prática baseada em atenção, disciplina e segurança.", "Praticantes que desejam ampliar sua consciência corporal e sua capacidade de reação.", "Quem procura integrar mente, corpo e espírito por meio das artes marciais."],
